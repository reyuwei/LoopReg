...
def main(mode, exp_id, optimizer, batch_size, epochs, num_labels, save_name=None, num_saves=None, augment=False, naked=False,
         split_file=None):
    ...
    # corr_net = PointNet2Part(in_features=0, num_parts=16, num_classes=3)
    corr_net = PointNet2Part(in_features=0, num_parts=num_labels, num_classes=3)
    ...
    if mode == 'train':
        dataset = MyDataLoader('train', batch_size, num_labels, num_workers=16, augment=augment, naked=naked,
...
if __name__ == "__main__":
    ...
    if args.mode == 'val':
        ...
        main('train', args.exp_id, args.optimizer, args.batch_size, args.epochs, args.num_labels, augment=args.augment, naked=args.naked,
             split_file=args.split_file)

    elif args.mode == 'eval':
        main('eval', args.exp_id, args.optimizer, args.batch_size, args.epochs, args.num_labels, augment=args.augment, naked=args.naked,
             split_file=args.split_file)
